...
export const WELLNESS: Record<string, WellnessModal> = {
  entoto: {
    ...
    facilities: [
      "Steam bath and Finnish sauna for deep relaxation.",
      "Rejuvenating massage therapies.",
      "Luxurious jacuzzi experience.",
      "Professional manicure services.",
      "Tranquil resting area.",
      "Premium pedicure treatments."
    ],
  },
  bishoftu: {
    ...
    facilities: [
      "Steam bath for deep relaxation.",
      ...
      "Fully equipped gym for workouts."
    ],
  },
  laketana: {
    ...
    facilities: [
      "Relaxing steam room experience.",
      "Traditional sauna for wellness.",
      "Luxurious jacuzzi retreat.",
      "Private massage rooms for ultimate relaxation.",
