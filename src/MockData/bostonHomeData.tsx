export const bostonHomeData = {
  ...
  rating: 0,
  cover_image: "https://kurifturesorts.com/_nuxt/img/ArtGallery.cb59c6c.webp",

  cover_video:
    "https://www.youtube.com/embed/tj0XFA9gGsM?autoplay=1&mute=1&loop=1&playlist=tj0XFA9gGsM&controls=0",
  art: {
    title: "Art Gallery",
    description:
      "As you wait for your appointment take a stroll around the entire Boston Day Spa floor and discover local art stationed all across. Make your own interpretations of the work through this experience!",
  },
