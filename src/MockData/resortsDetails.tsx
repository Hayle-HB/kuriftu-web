...
export const RESORTDETAILS: Record<string, ResortDetailsModal> = {
  ...
  awash: {
    ...
    longitude: 39.003129,
    location:
      "211 km from Addis Ababa Bole International Airport Awash Park Ethiopia",
    email: "booking@kurifturesorts.com",
    rating: 5,
    cover_image:
      "https://kurifturesorts.com/_nuxt/img/Accomodation1.c444805.webp",
    cover_video:
      "https://player.vimeo.com/video/722179226?api=1&autoplay=1&controls=0&sidedock=0&loop=1&title=0&byline=0&portrait=0&muted=1&background=1",
  },
  africanVillage: {
    isIframe: false,
